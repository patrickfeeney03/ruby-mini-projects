This program uses Caesar Encryption to encrypt any string. The character shift can either be to the left or right. The shift amount can be specified manually.
